...
This binaural sound filter renders a binaural output file out of a 3D scene that contains
...
I don't know much about licenses and copyright, but feel free to change the source code and use it in
your project, fix bugs, add new features. I published this under the GNU GPL v3.0, read the details here:
https://www.gnu.org/licenses/gpl-3.0.en.html

I am happy about feedback, ideas and code improvements. You can find the project on github:
https://github.com/hndi

To compile it, g++ worked pretty well when adding -std=c++11 to the command line.

Ideas for future versions:
* Threads! I didn't figure out how to avoid memory collisions while maintaining a high rendering speed
* Right now, reflection spots are selected on random walls. It would be better if rays were shooting out
and try to hit other walls and reflect from there. This would allow blocking walls, corners and indirect
reflections.
* Reduction of higher frequencies over distance and by reflection. In the real world, high frequencies
are reduced, which is not yet happening in this softare, which can lead to unrealistic high reverb sounds.
Didn't figure out a satisfying and high performance way to do that.
