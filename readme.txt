...
Use the GUI editor to configure your scene and select your raw input and output files. The editor
saves a file (*.b3s = binaural 3D scene) and launches the filter that does the calculations.
...
speaker=Speaker1;test.raw;1.0;1.0;1.75;1.0;;1.0,3.0,0.0,0.0/3.5,3.0,3.0,0.0/6.3,3.0,3.0,3.0
...
Format: microphone=<name><soundfile>;<X-Position>;<Y-Position>;<Z-Position>
Example:
microphone=Mic1;result.raw;0.0;0.0;1.7

The "2chanmic" saves a sound file with two channels and needs two threedimensional positions
as microphone positions.
Format: 2chanmic=<name>;<soundfile>;<Mic 1 X>;<Mic 1 Y>;<Mic 1 Z>;<Mic 2 X>;<Mic 2 Y>;<Mic 2 Z>
Example:
2chanmic=2ChanMic;output/output.raw;-0.08;0.0;1.75;0.08;0.0;1.75
...
realistic results.
Format: head=<name>;<soundfile>;<X-Position>;<Y-Position>;<Z-Position>;<Angle>;<Ear Distance>
Example:
head=Head;output/output.raw;1.0;0.0;1.7;180;0.18
...
Format: wall=<name>;<X-Position 1>;<Y-Position 1>;<Z-Position 1>;<X-Position 2>;<Y-Position 2>;<Z-Position 2>;<Amount>;[modifier]
Example (for a floor):
wall=Floor;-5.0;-1.0;0.0;5.0;6.0;0.0;0.9
...
Example: wall=ModWall;-5.0;-1.0;0.0;5.0;6.0;0.0;0.9;square,10,3,0
...
Format: room=<name>;<X-Position 1>;<Y-Position 1>;<Z-Position 1>;room=<X-Position 2>;<Y-Position 2>;<Z-Position 2>;<Amount>
Example:
room=Room;x-5.0;-1.0;0.0;5.0;6.0;3.0;0.9
...
Format: randomspawnspeaker=<name><file>;<X-Pos 1>;<Y-Pos 1>;<Z-Pos 1>;<X-Pos 2>;<Y-Pos 2>;<Z-Pos 2>;
        <Volume>;<Total Time>;<Min Pause>;<Max Pause>;[Min Speed];[Max Speed];[Flags]
Example:
randomspawnspeaker=RndSpeaker;test.raw;-10;0;0;10;20;5;1;60;3;6;0.8;1.2

"version" needs to be the first value in the file. it tells the engine, which file format should be used.
Current version is 0.5
Format: version=<version nr>
